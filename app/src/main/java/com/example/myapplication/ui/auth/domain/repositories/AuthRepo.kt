...
interface AuthRepo {
    ...
    suspend fun register(userData: RegisterRequest) : Response<MessageResponse>
    suspend fun forgetPassword(data: ForgetPasswordRequest) : Response<MessageResponse>
    suspend fun verifyPassword(data: VerifyPasswordRequest) : Response<MessageResponse>
}